...
| Phase 8 — the instance layer (options + parse cache) | 87.60 kB | 26.28 kB | 23.36 kB | 14.91 kB | `parse` 21%, `defineOperator` 13%, `staticChecks` 7%, `params` 6%, `string` 6% |

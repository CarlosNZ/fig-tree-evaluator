...
| Phase 8 — the instance layer (options + parse cache) | 88.11 kB | 26.46 kB | 23.54 kB | 14.83 kB | `parse` 21%, `defineOperator` 13%, `staticChecks` 7%, `params` 6%, `string` 6% |

...
- **`getData` / OBJECT_PROPERTIES → `get`**, everyday form to a `"$data.…"` string; a v2 `getData` + `fallback` maps near-losslessly to `get` + `default` ([v3-api.md:422](v3-api.md#L422)), preserving the null-vs-missing distinction.

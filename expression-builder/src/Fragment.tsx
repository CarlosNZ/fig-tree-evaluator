...
import { EvaluatorNode, FigTreeEvaluator, FragmentMetadata } from 'fig-tree-evaluator'
import { CustomNodeProps } from './json-edit-react/types'
import './styles.css'
import { NodeTypeSelector } from './NodeTypeSelector'
import { dequal } from 'dequal'
import { FragmentNode } from '../../src/types'
import { commonProperties, getDefaultValue, isAliasString, reservedProperties } from './helpers'
import { DropdownOption, PropertySelector } from './Operator'
...
const FragmentSelector: React.FC<{
  ...
  console.log('fragmentOptions', fragmentOptions)

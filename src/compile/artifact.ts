...
/**
 * Sort an issue stream into tree order, in place. A stable sort, so issues
 * from one node keep their emission order.
 */
export const sortIssues = (issues: SequencedIssue[]): void => {
